...
namespace VDT.Core.DependencyInjection {
    /// <summary>
    /// Commonly used implementations of the <see cref="ServiceRegistrationProvider"/> delegate
    /// </summary>
    public static class DefaultServiceRegistrationProviders {
        ...
        /// </summary>
        /// <returns>A <see cref="ServiceRegistrationProvider"/> that finds the service interface for an implementation type if only a single interface is found</returns>
        ...
        /// </summary>
        /// <returns>A <see cref="ServiceRegistrationProvider"/> that finds any service interfaces that match the name of an implementation type</returns>
        ...
        /// <returns>A <see cref="ServiceRegistrationProvider"/> that finds any matching constructed service types for an implementation type</returns>
